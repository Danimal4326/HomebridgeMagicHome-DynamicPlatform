...
export class HomebridgeMagichomeDynamicPlatformAccessory {
  ...
  constructor(
    ...
    this.accessory.getService(this.platform.Service.AccessoryInformation)!
      ...
      .setCharacteristic(this.platform.Characteristic.HardwareRevision, this.myDevice.controllerHardwareVersion.toString())
      .setCharacteristic(this.platform.Characteristic.FirmwareRevision, this.myDevice.controllerFirmwareVersion.toString()) //?
